...
目前可以通过 [unpkg.com/yongheui](https://unpkg.com/yongheui/) 获取到最新版本的资源，在页面上引入 js 和 css 文件即可开始使用。

```html
<!-- 引入样式 -->
<link rel="stylesheet" href="https://unpkg.com/yongheui/lib/theme-default/index.css">
<!-- 引入组件库 -->
<script src="https://unpkg.com/yongheui/lib/index.full.js"></script>
```
